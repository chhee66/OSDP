...
<body>
	<%
		...
		script.println("</script>");
			...
			Bbs2 bbs = new Bbs2DAO().getBbs(bbsID);
		...
		<div class="row">
         ...
         <table class="table table-default">
            <%
                  ...
                  ArrayList<Comment2> list = commentDAO.getList(bbsID);
            ...
            <!-- --두번째 td-- -->
               <td>
                  ...
                  <form method="post" action="updateComment2.jsp?bbsID=<%=bbsID%>&modNum=<%=list.get(i).getCommentID()%>">
                  <div>
                     <!-- 내용부분 -->
               ...
               <td style="width: 10%">
                  ...
                  <div>
                     <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteCommentAction2.jsp?commentID=<%=list.get(i).getCommentID() %>&bbsID=<%=bbsID %>" class="btn btn-default">삭제</a>
                  </div>

                  <div>
                     <a href="view2.jsp?bbsID=<%=bbsID %>&modNum=<%=list.get(i).getCommentID()%>#<%=list.get(i).getCommentID()%>" class="btn btn-default">수정</a>
                  </div>
               </td>
               <%
                     }
         ...
         <!-- -------------------------------------- 댓글을 쓰는부분 ----------------------------------------- -->
         <form method="post" action="writeCommentAction2.jsp?bbsID=<%=bbsID%>">
            <table class="table table-default">
               <tr>
