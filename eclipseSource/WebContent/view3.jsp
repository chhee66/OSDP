         ...
         <table class="table table-default">
            ...
            <!-- --두번째 td-- -->
               <td>
                  ...
                  <form method="post" action="updateComment3.jsp?bbsID=<%=bbsID%>&modNum=<%=list.get(i).getCommentID()%>">
                  <div>
                     <!-- 내용부분 -->
               ...
               <td style="width: 10%">
                  ...
                  <div>
                     <a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteCommentAction3.jsp?commentID=<%=list.get(i).getCommentID() %>&bbsID=<%=bbsID %>" class="btn btn-default">삭제</a>
                  </div>

                  <div>
                     <a href="view3.jsp?bbsID=<%=bbsID %>&modNum=<%=list.get(i).getCommentID()%>#<%=list.get(i).getCommentID()%>" class="btn btn-default">수정</a>
                  </div>
               </td>
               <%
                     }
